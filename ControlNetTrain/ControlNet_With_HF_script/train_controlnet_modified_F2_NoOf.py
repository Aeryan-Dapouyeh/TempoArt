...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--validation_data_dir",
        default="/work3/s204158/VideoDataSet/ValidationDataset",
        help=("A folder containing the validation data.")
    )
    parser.add_argument(
        "--validation_outputFile",
        default="/work3/s204158/ControlNetTrain_With_originalScript/validationResults",
        help=("The folder, where the result of validation would be saved.")
    )
    '''parser.add_argument(
...
def main(args):
    ...
    if wandb: 
        ...
        "Maximum number of training steps": args.max_train_steps,
        }
        )
    ...
    validation_dataset = ControlNetDataSet(
        data_root=args.validation_data_dir,
        tokenizer=tokenizer,
        size=args.resolution,
    )
    ...
    validation_dataloader = torch.utils.data.DataLoader(
        validation_dataset, batch_size=1, shuffle=False, num_workers=args.dataloader_num_workers
    )
...
--train_data_dir="/work3/s204158/VideoDataSet/ProcessedData" \
--resolution=512 \
--learning_rate=1e-5 \
--validation_image "/zhome/70/6/155860/Bachlorproject/ControlNet_Train_OriginalScript/ValidationImages/1/F1.png" \
